...
- [ ] Confirm TaskNotes has created the default `.base` files in `System/TaskNotes/Views/`.
...
- Duplicate `System/TaskNotes/Views/tasks-default.base` and make a view for one project.
